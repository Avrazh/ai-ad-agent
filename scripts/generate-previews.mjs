...
const TOKEN = process.env.PREVIEW_TOKEN ?? "demo2026";
const COOKIE = "preview_auth=" + TOKEN;
...
async function main() {
  ...
  const upRes = await fetch(BASE_URL + "/api/upload", { method: "POST", headers: { Cookie: COOKIE }, body: form });
