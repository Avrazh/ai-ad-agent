...
function build(spec: AdSpec, imageBase64: string, zonePx: PixelRect, safeZones?: SafeZones): string {
  ...
  const cardHtml = spec.hideHeadline ? "" : `
  <div style="
    position:absolute;
  ...
  ">
    ...
    ">
      ...
      <p data-fit-headline style="font-family:'${theme.fontHeadline}',sans-serif;font-size:clamp(13px,28px,28px);font-weight:400;color:${spec.headlineColor ?? theme.color};line-height:1.45;margin:0;word-break:normal;overflow-wrap:normal;">${quote}</p>
      ...
      <div style="display:flex;align-items:center;gap:12px;flex-shrink:0;">
        ...
        <div style="display:flex;flex-direction:column;gap:2px;">
          ${fullName
            ? `<span style="font-family:'${theme.fontHeadline}',sans-serif;font-size:28px;font-weight:700;color:${spec.headlineColor ?? theme.color};line-height:1.2;">${fullName}</span>
          <span style="font-family:'${theme.fontHeadline}',sans-serif;font-size:28px;font-weight:400;color:#888888;line-height:1.2;">${roleLabel}</span>`
            : `<span style="font-family:'${theme.fontHeadline}',sans-serif;font-size:28px;font-weight:700;color:${spec.headlineColor ?? theme.color};line-height:1.2;">${roleLabel}</span>`
          }
        </div>
      </div>
    </div>
